     ...
     {/* Navbar Responsive */}
          ...
          <Toolbar sx={{ justifyContent: 'space-between', py: 2 }}>
            ...
            <Box sx={{ display:'flex', 
                ...
                <Avatar
                 ...
                 sx={{ height: { xs: '40px', md: '50px' }, width: { xs: '40px', md: '50px' } }}/>
                 <Typography 
                   variant='h5'
                   component='h1'
      ...
      <Box
        sx={{
          ...
          display: 'flex',
          alignItems: 'center',
          backgroundImage: 'url("src/assets/WhatsApp Image 2025-09-05 à 04.59.34_3ef60bcb.jpg")', // Remplacez par votre image
